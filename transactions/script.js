    ...
    .done(response => {
      ...
      let $tabla = $("#datos").DataTable({
        ...
        buttons: [
          {
            text:
              '<a><i class="fas fa-plus" title="Insert"></i><span data-toggle="modal" data-target="#ModalCRUD"> Insert</span></a>',
          ...
          },
          {
            extend: "copyHtml5",
            text:
              '<a><i class="far fa-copy" title="Copy"></i><span> Copy</span></a>',
            className: "btn btn-dark",
            title: "Data export",
            exportOptions: {
              columns: ":visible"
          ...
          },
          {
            extend: "print",
            text:
              '<a><i class="fas fa-print" title="Print"></i><span> Print</span></a>',
            className: "btn btn-dark",
            title: "Data export.",
            exportOptions: {
              columns: ":visible"
